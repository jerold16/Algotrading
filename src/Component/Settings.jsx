...
{/* <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
...
</svg>  <input className='text-slate-900 outline-none  ' type="text" placeholder='' value="Jerold raja" />
                    </div>
                </div>
                <div className='my-2'>
                    Email-id
...
</svg>  <input className='text-slate-900 outline-none  ' type="text" placeholder='' value="jeroldraja12@gmail.com" />
                    </div>
                </div>
                <div className='my-2'>
                    Phone Number
  ...
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z"/>
</svg> <input className='text-slate-900 outline-none  ' type="text" placeholder='' value="9791582480" />
                    </div>
                </div>
            ...
            <div className={`w-fit ms-auto  ${edit? 'd-block':'d-none' }`}>
                <button className='text-blue-700 border-blue-700 mx-1 shadow p-1 px-4 border-1 rounded'> Cancel</button>
            ...
            <div className={`w-fit  mx-auto ${edit? 'd-none':'d-block' }`}>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-fill" viewBox="0 0 16 16">
  <path d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6"/>
</svg> <p className='mb-0 text-black'>Name: <span className='fw-semibold'> Jerold raja </span> </p>
                </div>
                <div className='flex items-center my-4 text-red-700 gap-3'>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-envelope-fill" viewBox="0 0 16 16">
  <path d="M.05 3.555A2 2 0 0 1 2 2h12a2 2 0 0 1 1.95 1.555L8 8.414zM0 4.697v7.104l5.803-3.558zM6.761 8.83l-6.57 4.027A2 2 0 0 0 2 14h12a2 2 0 0 0 1.808-1.144l-6.57-4.027L8 9.586zm3.436-.586L16 11.801V4.697z"/>
</svg> <p className='mb-0 text-black'>Email-id : <span className='fw-semibold'> jeroldraja12@gmail.com </span> </p>
                </div>
                <div className='flex items-center my-4 text-blue-700 gap-3'>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone-fill" viewBox="0 0 16 16">
  <path fill-rule="evenodd" d="M1.885.511a1.745 1.745 0 0 1 2.61.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.68.68 0 0 0 .178.643l2.457 2.457a.68.68 0 0 0 .644.178l2.189-.547a1.75 1.75 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.6 18.6 0 0 1-7.01-4.42 18.6 18.6 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877z"/>
</svg> <p className='mb-0 text-black'>Phone Number : <span className='fw-semibold'>+91 9791582480 </span> </p>
                </div>
