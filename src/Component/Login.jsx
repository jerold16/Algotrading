...
const Login = () => {
  ...
  let handlelogIn = (e) => {
    ...
    axios.post(`${hostname}/LoginAPIView/`,{
      Email:user.email,
      password: user.password
    }).then((response) => {
      console.log(response.data);
      sessionStorage.setItem('user',JSON.stringify(response.data.user.user_id))
      navigate('/welcome/')
    }).catch((error) => {
      console.log(error);
    })
  ...
  return (
    <div className="flex h-[100vh]">
      <Row className="container m-auto align-items-center min-h-[70vh] xl:min-h-[100vh]">
        <Col lg={6}>
        ...
        <Col lg={6}>
          ...
          >
            ...
            <div className="w-fit mx-auto">
              ...
              <button onClick={handlelogIn} className="bg-blue-600 hover:bg-blue-700 p-2 px-3 rounded text-white mx-auto w-fit flex ">
                Register
              </button>
            </div>
            <div>
